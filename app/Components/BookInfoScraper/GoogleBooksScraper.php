...
class GoogleBooksScraper implements ScraperInterface
{
     ...
     * 　配列でない場合はそのまま返す。
     */
    private function getFullAuthors($bookInfoAuthor){
     ...
     * 　なければ、タイトルをそのまま返す。
     */
    private function getFullTitles($bookInfo){
    ...
    public function searchByIsbn(string $isbn){
        ...
        $book->isbn = $isbn;
        $book->name = $this->getFullTitles($bookInfo);
        ...
        $book->author = $this->getFullAuthors($bookInfo->authors);
